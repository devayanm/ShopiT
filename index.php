...
<div class="container-fluid my-5">
    <div id="landingCarousel" class="landing carousel slide pt-5" data-bs-ride="carousel">
            ...
            <div class="carousel-item active">
                <div class="container pt-4">
                    <div class="row m-0">
                        <div class="">
                            <div class="cover">
                                <span class="title">Iphone 15 series</span>
                                <span class="desc">Up to 10%<br />off Voucher</span>
                                <a href="./products.php">Shop now -></a>
                            </div>
                        </div>
            ...
            <div class="carousel-item active">
                <div class="container pt-4">
                    <div class="row m-0">
                        <div class="">
                            <div class="cover">
                                <span class="title">Iphone 16 series</span>
                                <span class="desc">Up to 10%<br />off Voucher</span>
                                <a href="./products.php">Shop now -></a>
                            </div>
                        </div>
