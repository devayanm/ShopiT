...
<body>
    <div class="fixed-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container">
                <a class="navbar-brand fw-bold" href="#">ShopiT</a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" class="d-flex align-items-center gap-1" href="#">
                                ...
                                if (!isset($_SESSION['username'])) {
                                    ...
                                    echo "<span class='pseudolink' onclick='window.location.href=\"./users_area/profile.php\"'>Welcome " . $_SESSION['username'] . "</span>";
                                }
                                ?>
                            </a>
                        </li>
